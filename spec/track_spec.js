...
describe('mapping Track to an object', function(){
  ...
  var push_double = {push: function(midi_ids){return {key: 'SOME_RANDOM_FB_KEY'}},
                      on: function(value){},
                      set: function(value){},
                      child: function(name){return {set: function(value){listofMidis_mock.push(1), console.log('from SET in mock',listofMidis_mock)}}}
  ...
  it("adds midi_id's", function(){
    track.add_midi(1);
    console.log('from the test', track.midi_ids())
